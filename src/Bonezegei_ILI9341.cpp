...
void Bonezegei_ILI9341::col(uint16_t st, uint16_t en) {
  sendCommand(0x2a);
  sendData(st >> 8);
  sendData(st);
  sendData(en >> 8);
...
void Bonezegei_ILI9341::row(uint16_t st, uint16_t en) {
  sendCommand(0x2b);
  sendData(st >> 8);
  sendData(st);
  sendData(en >> 8);
...
void Bonezegei_ILI9341::spi24(uint32_t dat) {
  spiWriteShortNL(vspi->bus(), dat >> 8);
  spiWriteByteNL(vspi->bus(), dat);
}

void Bonezegei_ILI9341::spi16(uint16_t dat) {
  spiWriteShortNL(vspi->bus(), dat);
}

void Bonezegei_ILI9341::clear(uint32_t color) {
  vspi->setFrequency(ILI9341_SPISPEED);
  col(0, 240);
  row(0, 320);
  sendCommand(0x2c);
...
void Bonezegei_ILI9341::drawFilledRectangle(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, uint32_t color) {
...
void Bonezegei_ILI9341::drawRectangle(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, uint32_t color) {
...
void Bonezegei_ILI9341::drawRectangleStrip(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, uint32_t color) {
  unsigned char mod = 2;
...
void Bonezegei_ILI9341::drawCircle(uint16_t x1, uint16_t y1, uint16_t r, uint32_t color) {
...
void Bonezegei_ILI9341::drawBitmap(uint16_t x1, uint16_t y1, int xbytes, int yheight, const char bitmap[], uint32_t color) {
  int cnt = 0;
...
void Bonezegei_ILI9341::drawRoundFilledRectangle(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, uint16_t r, uint32_t color) {
  int x, y, xd;
...
void Bonezegei_ILI9341::setChar8(uint16_t x, uint16_t y, char ch, int bits, uint32_t color) {
  int b = 0;
...
void Bonezegei_ILI9341::drawChar(int x, int y, char ch, uint32_t color, const char fd[], const int dsc[95][3]) {
  int b = ch - 32;
  int xLimit = 320;
  //int yLimit = 240;
...
void Bonezegei_ILI9341::drawText(int x, int y, const char *str, uint32_t color, const char fd[], const int dsc[95][3]) {
  xRun = x;
  yRun = y;
  vspi->setFrequency(ILI9341_SPISPEED);
  while (*str) {
...
void Bonezegei_ILI9341::drawText(int x, int y, const char *str, uint32_t color) {
  xRun = x;
  yRun = y;
  vspi->setFrequency(ILI9341_SPISPEED);
  while (*str) {
...
void Bonezegei_ILI9341::setFontParam(const char fd[], const int dsc[95][3]) {
  font.fnt = (char *)fd;
  for (int b = 0; b < 95; b++) {
    for (int a = 0; a < 3; a++) {
...
void Bonezegei_ILI9341::setFont(FONT_TYPE ft) {
